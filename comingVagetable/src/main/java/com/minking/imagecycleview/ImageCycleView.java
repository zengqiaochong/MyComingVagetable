...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 装填图片数据
	 * 
	 * @param infoList 图片url的集合
	 * @param imageCycleViewListener
	 */
	public void setImageResources(ArrayList<PicSlideInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		...
		for (int i = 0; i < imageCount; i++) {
			...
			LinearLayout.LayoutParams layout = new LinearLayout.LayoutParams((int)mScale*30,(int)mScale*2);
			...
			if (i == 0) {
				mImageViews[i].setBackgroundResource(R.drawable.circle_selected);
			} else {
				mImageViews[i].setBackgroundResource(R.drawable.circle_unselected);
			}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			index -= 1;
			mImageViews[index].setBackgroundResource(R.drawable.circle_selected);
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private ArrayList<PicSlideInfo> mAdList = new ArrayList<PicSlideInfo>();
		...
		public ImageCycleAdapter(Context context, ArrayList<PicSlideInfo> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
	...
	public interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		void onImageClick(PicSlideInfo info, int position, View imageView);
	}
