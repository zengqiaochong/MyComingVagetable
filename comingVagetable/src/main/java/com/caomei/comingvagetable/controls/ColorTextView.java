...
//	private static final int DEFAULT_MARGIN_DIP = 5;
	 ...
	 * Constructor -
	 * 
	 * create a new NewsIndicator instance attached to a target
	 ...
	 */
	public ColorTextView(Context context, View target) {
	 ...
	 */
	public ColorTextView(Context context, TabWidget target, int index) {
