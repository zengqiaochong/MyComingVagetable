...
public class AlipayUtil {
	...
	public AlipayUtil(Activity mActivity, float price,String url,String remark) {
	...
	public void Pay() {
		String orderInfo = getOrderInfo("菜来了商品", remark,
				String.valueOf(price));
//		String orderInfo = getOrderInfo("菜来了商品",remark,
//				"0.01");
		Log.e("sb", "info "+orderInfo+"  notify url "+notify_url);
		// 对订单做RSA 签名
...
//				String resultInfo = payResult.getResult();
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(mActivity, "检查结果为：" + msg.obj, Toast.LENGTH_SHORT)
						.show();
				break;
			}
			default:
